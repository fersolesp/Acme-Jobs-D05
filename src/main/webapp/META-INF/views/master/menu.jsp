...
<acme:menu-bar code="master.menu.home">
	...
	<acme:menu-right>
		...
		<acme:menu-option code="master.menu.user-account" access="isAuthenticated()">
			...
			<acme:menu-suboption code="authenticated.employer.employer.form.button.create" action="/authenticated/employer/create" access="!hasRole('Employer')"/>
			<acme:menu-suboption code="authenticated.employer.employer.form.button.update" action="/authenticated/employer/update" access="hasRole('Employer')"/>
			<acme:menu-suboption code="authenticated.worker.worker.form.button.create" action="/authenticated/worker/create" access="!hasRole('Worker')"/>
			<acme:menu-suboption code="authenticated.worker.worker.form.button.update" action="/authenticated/worker/update" access="hasRole('Worker')"/>
		</acme:menu-option>
